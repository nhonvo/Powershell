...
{
    public static string LoggedIn(string accountName = "default") => $"[bold green]✔ Logged In ({accountName.EscapeMarkup()})[/]";
    public static string LoggedOut => "[bold red]✖ Logged Out[/]";
    public static string Online => "[bold green]ONLINE[/]";
    public static string Offline => "[bold red]OFFLINE[/]";
    public static string Syncing => "[bold yellow]SYNCING...[/]";
}
