...
public static class ScrollableViewport
{
    public static (int TopRow, int EndRow) ComputeViewport(int totalItems, int selectedIndex, int maxVisibleRows) => ScrollableListView.ComputeViewport(totalItems, selectedIndex, maxVisibleRows);
}
