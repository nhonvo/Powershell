...
public sealed class UiConfig
{
    ...
    public string[] FavoriteAliases { get; set; } = ["proj", "ide", "ollama", "disk"];
}
...
{
    public string PoshThemesPath { get; set; } = "shell/assets/powershell-themes";
    public string PsModulePath { get; set; } = "shell/modules";
