...
REPO_ROOT="$(cd "$CURRENT_SCRIPT_DIR/.." 2>/dev/null && pwd)"
...
cc() {
    local tui_dll="$REPO_ROOT/csapp/AgyTui/bin/Release/net9.0/AgyTui.dll"
    local proj_path="$REPO_ROOT/csapp/AgyTui/AgyTui.csproj"
