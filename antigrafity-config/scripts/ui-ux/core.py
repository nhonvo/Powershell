...
# ============ CONFIGURATION ============
PROJECT_ROOT = Path("c:/Users/TruongNhon/Documents/Powershell/antigrafity-config/mission-control-master")
DATA_DIR = PROJECT_ROOT / ".agent" / "skills" / "ui-ux-pro-max" / "data"
MAX_RESULTS = 3
