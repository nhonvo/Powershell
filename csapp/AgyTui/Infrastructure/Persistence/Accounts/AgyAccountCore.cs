...
public static class AgyAccountCore
{
    ...
    public static string GetActiveAccount() => AccountRepository.GetActiveAccount();
    ...
    public static void SetActiveAccount(string accountName, bool temporary = false)
    {
    ...
    public static bool IsNoAutoCommitEnabled() => File.Exists(NoAutoCommitFile);
    ...
    public static void ClearStatsCache() => _statsCache.InvalidateAll();
