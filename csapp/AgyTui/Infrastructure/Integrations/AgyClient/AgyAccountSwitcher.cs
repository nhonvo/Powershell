...
public class AgyAccountSwitcher : IAgyAccountSwitcher
{
    ...
    public void DeleteAccount(string accountName)
    {
        ...
        bool wasActive = string.Equals(AgyAccountCore.GetActiveAccount(), accountName, StringComparison.OrdinalIgnoreCase);
    ...
    {
        if (string.Equals(AgyAccountCore.GetActiveAccount(), accountName, StringComparison.OrdinalIgnoreCase))
        {
            AgyKeyringHelper.DeleteToken("gemini:antigravity");
        }
    ...
    public string? FindAutoSwitchCandidate()
    {
        ...
        foreach (var acc in AgyAccountCore.GetAccounts())
        {
