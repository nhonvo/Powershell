                                ...
                                while (true)
                                {
                                    ...
                                    var selectedChoice = AnsiConsole.Prompt(
                                        new SelectionPrompt<string>()
                                            .Title("[bold cyan]⭐️ Favorites Manager[/]\n[grey]Left: Command Alias | Right: Description (Type to search):[/]")
                                            .PageSize(15)
                                            .EnableSearch()
                                            .SearchPlaceholderText("[grey](Type to search favorites...)[/]")
                                            .AddChoices(choices));
                                    ...
                                    if (selectedChoice.StartsWith("⚡ "))
                                    {
                                        ...
                                        var subPrompt = AnsiConsole.Prompt(
                                            new SelectionPrompt<string>()
                                                ...
                                                .AddChoices([
                                                    $"🚀 Launch /{rawAlias}",
                                                    $"✏️ Edit / Search Replacement for /{rawAlias}",
