...
public static class Program
{
    public static void Main(string[] args)
    {
        ...
        try
        {
            AgyTui.Core.Registries.CommandRegistry.AssertSwitchCases();
            AgyTui.Core.Registries.CommandRegistry.AssertAllAliasesReachable(MenuNodeBuilder.BuildTree());
        }
        catch (Exception ex)
        {
    ...
    public static void RunCommand(string alias, string[]? args = null)
    {
        ...
        var cmdEntry = Core.Registries.CommandRegistry.GetByAlias(lAlias);
        if (cmdEntry != null)
        {
