...
APPS := agyswitch agyproj agygit agydocker agyterm agyx agymobile

.PHONY: all build install test test-v clean windows help $(APPS) mobile

all: install

help:
	@echo "=================================================================="
	@echo "⚡ Antigravity Developer Suite (Go Engine)"
	@echo "=================================================================="
	@echo "Usage:"
	@echo "  make build         Build all 7 Linux binaries to ./bin/"
	@echo "  make install       Build & install all binaries to $(INSTALL_DIR)"
	@echo "  make test          Run unit test suites across all 7 applications"
	@echo "  make windows       Cross-compile Windows .exe binaries to $(DIST_WIN)"
	@echo "  make <app>         Build & install a single app (e.g. make mobile)"
	@echo ""
	...
	@echo "  make git           Build agygit    (Git Cockpit, Worktrees)"
...
install:
	...
	@echo "✔ All 6 apps installed to $(INSTALL_DIR)/"
