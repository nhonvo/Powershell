...
public static class AppPaths
{
    ...
    public static string RepoRoot
    {
        get
        {
            ...
            if (!string.IsNullOrEmpty(envRoot) && (File.Exists(Path.Combine(envRoot, "apps", "agytui", "AgyTui", "profile.config.json")) || File.Exists(Path.Combine(envRoot, "csapp", "AgyTui", "profile.config.json")) || File.Exists(Path.Combine(envRoot, "profile.config.json"))))
            {
                _repoRoot = envRoot;
                return _repoRoot;
            }
            ...
            while (curr != null)
            {
                if (File.Exists(Path.Combine(curr.FullName, "apps", "agytui", "AgyTui", "profile.config.json")) || File.Exists(Path.Combine(curr.FullName, "csapp", "AgyTui", "profile.config.json")))
                {
                ...
                {
                    _repoRoot = (string.Equals(curr.Name, "AgyTui", StringComparison.OrdinalIgnoreCase) || string.Equals(curr.Name, "agytui", StringComparison.OrdinalIgnoreCase) || string.Equals(curr.Name, "csapp", StringComparison.OrdinalIgnoreCase)) && curr.Parent != null
    ...
    public static string ConfigFile
    {
        get
        {
            ...
            {
                var repoSeed = Path.Combine(RepoRoot, "apps", "agytui", "AgyTui", "profile.config.json");
                if (!File.Exists(repoSeed)) repoSeed = Path.Combine(RepoRoot, "csapp", "AgyTui", "profile.config.json");
