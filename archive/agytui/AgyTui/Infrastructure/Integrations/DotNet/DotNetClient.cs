...
public class DotNetClient : CliToolWrapper, IDotNetClient
{
    ...
    public int Publish(string? projectPath = null) => RunDotnet(File.Exists(Path.Combine(AppPaths.RepoRoot, "apps", "agytui", "AgyTui", "AgyTui.csproj")) ? "publish apps/agytui/AgyTui/AgyTui.csproj -c Release -r win-x64 --self-contained -o apps/agytui/AgyTui/dist" : "publish csapp/AgyTui/AgyTui.csproj -c Release -r win-x64 --self-contained -o csapp/AgyTui/dist", projectPath);
